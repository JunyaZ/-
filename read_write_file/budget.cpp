...
int main()
{
	...
	indata.open("indata.dat", ios::out | ios::binary);	// open file as binary output.
    ...
    char again; //hold Y or N to ask if the user wants to write another record.
	...
	person.net = person.income - person.food - person.rent - person.utilities - person.miscell;
	cout << "The net money of this person is :" << person.net << endl;
	...
	// write information to output file
		outdata << "Name" << setw(13) << "Income" << setw(9) << "Rent"
	...
	do
	{
	    ...
	    outdata<< person.name<<setw(10)<< person.income<<setw(10)
	    << person.rent<<setw(10)<< person.food<<setw(10)
	    << person.utilities<<setw(11)<< person.miscell<<setw(14)
	    << person.net<<endl;
